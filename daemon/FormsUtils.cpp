...
/* static */ int FormsUtils::debug = 0;

/* static */ const char* FormsUtils::downloadWindowTypeEnumStrings[] = { "DAY", "EVENING", "WEEKEND" };

/* static */ string FormsUtils::accessionNumberFromFilePath( const string& sFilePath ){
...
/* static */ string FormsUtils::isoDateFromYyyyMmDd( const string& sYyyyMmDd ){
...
/* static */ bool FormsUtils::nuttinButNumbers( const string& s_input ){
...
/* static */ string FormsUtils::cikFromUrl( const string& sUrl ){

	const char* sWho = "FormsUtils::cikFromUrl";
	...
	//	<< 	"\t" << "e.what() = \"" << e.what() << "\"\n"
	//	<< 	"\t" << "e.code() = " << e.code() << " = \"" << FormsUtils::regex_error_code_to_string(e.code()) << "\"...\n"
	//	<< "...re-throwing..." << endl;
	//	throw e;
	//}
	...
	for( size_t i = 0; i < elems.size(); i++ ){
		...
		if( FormsUtils::nuttinButNumbers( elems[i] ) ){
...
/* static */ string FormsUtils::double_quote_escape(const string& input){
...
/* static */ string FormsUtils::regex_error_code_to_string( std::regex_constants::error_type le_error_code ){

...
.\build\mongoc.exe command -uri "mongodb://prnvf-jayne/" -db "forms_mean" -collection "forms" -command "{ \"insert\": \"forms\", \"documents\": [ { \"name\": \"Larry\", \"accession_number\": 2, \"faux\": true } ] }" 2>&1 | tee d.out
